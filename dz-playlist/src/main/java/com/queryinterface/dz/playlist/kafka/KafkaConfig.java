...
import com.queryinterface.dz.playlist.kafka.messages.TrackSearchFailed;
...
public class KafkaConfig {
    ...
    */
    ...
    public JsonDeserializer<String> getJsonDeserializer(Map<String, Class<?>> classMapping) {
        ...
        configs.put(JsonDeserializer.VALUE_TYPE_METHOD, "com.queryinterface.dz.playlist.kafka.KafkaConfig.getMessageType");
